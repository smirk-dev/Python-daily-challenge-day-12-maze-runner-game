...
A **procedurally generated maze game** built using **Pygame**. Navigate through the labyrinth, avoid walls, and reach the green exit to win! Features **smooth movement, background music, and dynamic UI**.

## 🛠 Features
- **Randomly generated mazes** every playthrough.
- **Beautiful gradient background** and polished UI.
- **Smooth player movement** with sound effects.
- **Last runtime tracking** to see how fast you escape!
- **Background music** for an immersive experience.

## 🎮 How to Play
1. **Run the game** and navigate the **menu screen**.
2. Click **"Play"** to start the maze challenge.
3. Use the **arrow keys** to move your character.
4. Avoid walls and **reach the green exit** to win.
5. Your **completion time is saved** for reference!
